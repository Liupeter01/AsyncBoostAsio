...
BoostAsioProject::SyncLogic::SyncLogic() :_b_stop(false) 
{
...
BoostAsioProject::SyncLogic::~SyncLogic() 
{
          _b_stop = true;
...
void  BoostAsioProject::SyncLogic::commitPairToQueue(std::shared_ptr<BoostAsioProject::LogicPair> logicpair)
{
...
void BoostAsioProject::SyncLogic::deployCallBack(std::shared_ptr<BoostAsioProject::LogicPair> session)
{
...
void BoostAsioProject::SyncLogic::processLogicPair()      //multi-thread
{
          for (;;) {
...
void BoostAsioProject::SyncLogic::registerCallBack()      //register basic callback
{
...
void  BoostAsioProject::SyncLogic::callBackExample(std::shared_ptr<Session>session, const short& msg_id, const std::string& msg)
{
          Json::Value root;
          Json::Reader reader;
